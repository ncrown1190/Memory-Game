...
// randomnising the card array and getting a positive number
...
const checkForCardMatch = () => {
  ...
  const firstOptionId = chosencardId[0];
  const secondOptionId = chosencardId[1];

  if (firstOptionId == secondOptionId) {
    cards[firstOptionId].setAttribute("src", "assets/pattern.png");
    cards[secondOptionId].setAttribute("src", "assets/pattern.png");
    alert("You have clicked the same image!");
  } else if (chosenCard[0] === chosenCard[1]) {
    alert("Your cards match! you got a point.");
    cards[firstOptionId].setAttribute("src", "assets/white.png");
    cards[secondOptionId].setAttribute("src", "assets/white.png");
    cards[firstOptionId].removeEventListener("click", cardFlipped);
    cards[secondOptionId].removeEventListener("click", cardFlipped);
